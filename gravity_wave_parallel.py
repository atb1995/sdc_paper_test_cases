...
from firedrake import (
    ...
    Function, pi, COMM_WORLD, Ensemble
)
import numpy as np
from gusto import (
...
skamarock_klemp_nonhydrostatic_defaults = {
    ...
    'tmax': 3000.,
    'dumpfreq': 125,
    'dirname': 'skamarock_klemp_nonhydrostatic_parallel'
}
...
def skamarock_klemp_nonhydrostatic(
    ...
    base_scheme = IMEX_Euler(domain,nonlinear_solver_parameters=nl_solver_parameters)
    node_type = "LEGENDRE"
    ...
    scheme =SDC(base_scheme, domain, M, k, quad_type, node_type, qdelta_imp,
                        qdelta_exp, formulation="Z2N", nonlinear_solver_parameters=nl_solver_parameters,final_update=True, initial_guess="base")
    # Time stepper
